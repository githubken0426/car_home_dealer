...
<script type="text/javascript">
  	...
  	$(function(){
		...
		var deleteFlag = $.trim($("#deleteFlag").val());
  		...
  		kkpager.init({
  			...
  			hrefFormer : '${pageContext.request.contextPath}/homeCarousel_listData',//链接前部
	...
	//按条件查询
  	function query(){
  		$("#totalForm").attr("action","${pageContext.request.contextPath}/homeCarousel_listData.action");
	  	$("#totalForm").submit();
  	}
  	//重置
  	function clean(){
  	...
  	function addDataPage(){  		
  		$("#totalForm").attr("action","${pageContext.request.contextPath}/homeCarousel_addDataPage.action");
	  	$("#totalForm").submit();
  	}
  	//修改
  	function updateDataPage(){
  		...
  		if (ret == 0) {
			...
			$("#totalForm").attr("action","${pageContext.request.contextPath}/homeCarousel_updateDataPage.action");
			$("#totalForm").submit();	
  		}
  	}
  	...
  	function deleteData(){
  		...
  		if(checkboxs.is(":checked")){
	  		$("#totalForm").attr("action","${pageContext.request.contextPath}/homeCarousel_deleteData.action");
	  		$("#totalForm").submit();
  		}else{
  			alert("请选择修改项！");
  		}
		...
		<form action="" method="post" id="totalForm" >
			...
			<div class="content-box">
			    <div class="content-box-header">
			    	<span class="now_location">当前位置:</span>[首页广告]
			        <div class="clear"></div>
			    </div>
