...
<div id="middle">
	<div class="right"  id="mainFrame">
		<form action="${pageContext.request.contextPath}/self_driving_trowellingAction!updateData.action" method="post" id="updateForm">
			    ...
			    <div style="margin:0 auto; margin:10px;">
	            	...
	            	<table class="table table-bordered" >
						...
						<tr>
							...
							<td>
							<input type="text" id="title" name="entity.title"  value="${entity.title }"  tabindex="2" style="width:400px;margin-left:30px;"/>
						...
						<tr>
							...
							<td>
							<input type="text" id="content" name="entity.content"  value="${entity.content }"  tabindex="3" style="width:400px;margin-left:30px;"/>
						...
						<tr>
							...
							<td>
							<input type="text" id="picUrls" name="entity.picUrls"  value="${entity.picUrls }"  tabindex="4" style="width:400px;margin-left:30px;"/>
						...
						<tr>
							...
							<td>
							<input type="text" id="availableFlag" name="entity.availableFlag"  value="${entity.availableFlag }"  tabindex="5" style="width:400px;margin-left:30px;"/>
