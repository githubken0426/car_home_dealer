...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <script type="text/javascript">
	...
	var shopScoreIsOK = false;
	var shopDescriptionIsOK = true;
	var longitudeIsOK = false;
	var latitudeIsOK = false;
...
<div id="middle">
	<div class="right"  id="mainFrame">
		<form action="${pageContext.request.contextPath}/shop!addData.action" method="post" id="addForm" enctype="multipart/form-data">
		   		...
		   		<div style="margin:0 auto; margin:10px;">
	            	...
	            	<table class="table table-bordered" >
						...
						<tr>
							...
							<td width="40%">
							<input type="text" id="longitude" name="entity.longitude" tabindex="13" style="width:200px;margin-left:30px;"/>
							...
							<td width="40%">
							<input type="text" id="latitude" name="entity.latitude" tabindex="14" style="width:200px;margin-left:30px;"/>
						...
						<tr>
							...
							<td colspan="3">
							<textarea placeholder="简介在1000字以内有效" id="shopDescription" name="shopDescription" tabindex="15" style="width:75%;height:100px;margin:5px 0px 5px 30px;"></textarea>
							</td>
						</tr>
						<tr>
							...
							<input type="text" readonly="readonly" id="city" name="entity.city" value="${city}" tabindex="13" style="width:200px;margin-left:30px;"/>
							<%-- <select id="cityId" name="cityId" tabindex="17" style="width:200px;height:25px;margin-left:30px;">
						...
						<tr>
							...
							<td width="40%">
							<input type="text" id="district" name="entity.district" tabindex="18" style="width:200px;margin-left:30px;"/>
							<span id="districtMsg" style="margin-left:15px;"></span>
							</td> -->
							<td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1" height="40px">详细地址：</td>
							<td colspan="3">
							<input type="text" id="detailAddress" name="entity.detailAddress" tabindex="18" style="width:600px;margin-left:30px;"/>
						...
						<tr>
							...
							<td colspan="3">
							<input type="text" id="telNumberList" name="entity.telNumberList" tabindex="19" style="width:600px;margin-left:30px;"/>
						...
						<!-- <tr>
							...
							<td>
							<input type="text" id="isTop" name="entity.isTop" tabindex="18" style="width:400px;margin-left:30px;"/>
						...
						<tr>
							...
							<td>
							<input type="text" id="displayPriority" name="entity.displayPriority" tabindex="19" style="width:400px;margin-left:30px;"/>
						...
						<tr>
							...
							<input type="hidden" name="picFlag" id="picFlag" value="" />
							 ...
							 <input onchange="viewUploadImg(this,'viewPortrait')" type="file" name="myFile" tabindex="20"
						...
						<tr>
							...
							<div style="height:60px;width:450px;float:left;">
							<input onchange="viewUploadImg(this,'viewPortrait1')" type="file" name="displayPicUrl1" tabindex="21"
								style="width: 350px; margin-left: 30px;" />
							<img src="" 
								style="width:50px;height:50px;border:0px;display:none;" id="viewPortrait1"/>
							</div>
							<!-- <input type="file" id="displayPicUrl2" name="displayPicUrl2" style="width:400px;margin-left:30px;"/> -->
							<div style="height:60px;width:450px;float:left;">
							<input onchange="viewUploadImg(this,'viewPortrait2')" type="file" name="displayPicUrl2" tabindex="22"
								style="width: 350px; margin-left: 120px;" />
							<img src="" 
								style="width:50px;height:50px;border:0px;display:none;" id="viewPortrait2"/>
							</div>
							</div>
							<div style="margin:10px 0px 10px 0px;">
							...
							<div style="height:60px;width:450px;float:left;">
							<input onchange="viewUploadImg(this,'viewPortrait3')" type="file" name="displayPicUrl3" tabindex="23"
								style="width: 350px; margin-left: 30px;" />
							<img src="" 
								style="width:50px;height:50px;border:0px;display:none;" id="viewPortrait3"/>
							</div>
							<div style="height:60px;width:450px;float:left;">
							<input onchange="viewUploadImg(this,'viewPortrait4')" type="file" name="displayPicUrl4" tabindex="24"
								style="width: 350px; margin-left: 120px;" />
							<img src="" 
								style="width:50px;height:50px;border:0px;display:none;" id="viewPortrait4"/>
							</div>
							</div>
							<div style="margin:10px 0px 10px 0px;">
							<div style="height:60px;width:450px;float:left;">
							<!-- <input type="file" id="displayPicUrl5" name="displayPicUrl5" style="width:400px;margin-left:30px;"/> -->
							<input onchange="viewUploadImg(this,'viewPortrait5')" type="file" name="displayPicUrl5" tabindex="25"
								style="width: 350px; margin-left: 30px;" />
							<img src="" 
								style="width:50px;height:50px;border:0px;display:none;" id="viewPortrait5"/>
							</div>	
							</div>
							</td>
						</tr>
