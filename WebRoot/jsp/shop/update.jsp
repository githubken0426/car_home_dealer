			    ...
			    <div style="margin:0 auto; margin:10px;">
	            	<table class="table table-bordered" >
								...
								<c:forEach var="category" items="${categoryList }">
				   	 				<label style="margin-left:30px;">
				   	 					<input type="checkbox" name="categoryId" value="${category.id}"
				   	 						<c:if test='${fn:contains(entity.categoryList,category.id)}'>checked='checked' </c:if>/>
				   	 					${category.title}
				   	 				</label>
				   	 			</c:forEach>
							</td>
						...
						<tr>
							...
							<td width="40%">
							<input type="text" onblur="matcher(this)" id="shopScore" name="entity.shopScore" value="${entity.shopScore }" tabindex="13" style="width:200px;margin-left:30px;"/>
