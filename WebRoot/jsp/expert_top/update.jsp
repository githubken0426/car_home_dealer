...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <script type="text/javascript">
   //添加提交
   function addSubmit(){
	   var v=$("input[name='expertTop.deleteFlag']:checked").val()
	   if(isViewUpdateOK){
		   if(1==v){
			   if(confirm("禁用达人，其发表的文章也将禁用，确定修改吗")){
				   $("#addForm").submit();
			   }
		   }else
			   $("#addForm").submit();
...
<!-- 用户录入区  -->
			     	<div class="content-box-header">
				    	<span class="now_location">用户信息:</span>
				        <div class="clear"></div>
				    </div>
...
<!-- 达人录入区  -->
				    <div class="content-box-header">
				    	<span class="now_location">达人信息:</span> 修改达人
				        <div class="clear"></div>
				    </div>
