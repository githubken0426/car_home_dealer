jQuery(function() {
	...
	function setState(val) {
		...
		case 'ready':
			...
			$('#filePickerBig2').removeClass('element-invisible');
			...
			break;
		case 'uploading':
			$('#filePickerBig2').addClass('element-invisible');
			$progress.show();
			$upload.text('暂停上传');
			break;
		case 'paused':
	...
	uploader.onUploadSuccess = function(file, response) {
		...
		if(url!='Error'){
			var imgPath="<input type='hidden' name='bigPicture' value='"+url+"'/>";
