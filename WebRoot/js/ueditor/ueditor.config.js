	...
	window.UEDITOR_CONFIG = {
		...
		toolbars : [ [ 'fullscreen', 'source', '|', 'undo', 'redo', '|',
				...
				'mergedown', 'splittocells', 'splittorows', 'splittocols',
				 '|', 'print', 'preview', 'searchreplace','removeformat', 'formatmatch','cleardoc' ] ]
		//注释掉的功能按钮
		//'scrawl', 'insertvideo', 'music','attachment', 'map', 'gmap', 
		//'insertframe', 'insertcode','webapp', 'pagebreak', 'template', 'background', '|',', 'drafts',
		//	'help''snapscreen','wordimage','charts',
